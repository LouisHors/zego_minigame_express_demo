...
namespace CONNECTION
{
    ...
    const ZCError kZCEAgentTCPSSLUnkownError                       = kZCEAgentTcpBase + 999;
    ...
    struct NetAgentAddressGroup
    {
        ...
        std::vector<std::string> quicNodes;    //node format: ip:port
        std::vector<std::string> mtcpNodes;
    };
